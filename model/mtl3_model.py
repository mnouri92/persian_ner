...
class MTL3CharCNNWordBilstmModel(Model):

    def __init__(self, vocab_size, dim, task1_tag_size, task2_tag_size, task3_tag_size, max_word_len, char_emb_dim, lstm_size, learning_rate
    ...
    def add_pred_op(self):
        ...
        self.task3_labels_pred = tf.contrib.crf.crf_decode(self.task3_logits, self.task3_transition_param, self.sentence_lenghts)[0]
